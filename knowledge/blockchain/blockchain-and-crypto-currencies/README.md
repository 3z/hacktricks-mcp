...
> Related: [value-centric-web3-red-teaming.md](value-centric-web3-red-teaming.md)
...
> Related: [web3-signing-workflow-compromise-safe-delegatecall-proxy-takeover.md](web3-signing-workflow-compromise-safe-delegatecall-proxy-takeover.md)
...
> Related: [erc-4337-smart-account-security-pitfalls.md](erc-4337-smart-account-security-pitfalls.md)

## Smart Contract Security

- Mutation testing to find blind spots in test suites:

> Related: [../smart-contract-security/mutation-testing-with-slither.md](../smart-contract-security/mutation-testing-with-slither.md)
...
> Related: [defi-amm-hook-precision.md](defi-amm-hook-precision.md)

For multi-asset weighted pools that cache virtual balances and can be poisoned when `supply == 0`, study:

> Related: [defi-amm-virtual-balance-cache-exploitation.md](defi-amm-virtual-balance-cache-exploitation.md)
