...
> Related: [../../network-services-pentesting/pentesting-smb/](../../network-services-pentesting/pentesting-smb/)

- **Enumerate Ldap**
  - `nmap -n -sV --script "ldap* and not brute" -p 389 <DC IP>`
  - A more detailed guide on how to enumerate LDAP can be found here (pay **special attention to the anonymous access**):

> Related: [../../network-services-pentesting/pentesting-ldap.md](../../network-services-pentesting/pentesting-ldap.md)
...
> Related: [password-spraying.md](password-spraying.md)

### LLMNR/NBT-NS Poisoning

You might be able to **obtain** some challenge **hashes** to crack **poisoning** some protocols of the **network**:

> Related: [../../generic-methodologies-and-resources/pentesting-network/spoofing-llmnr-nbt-ns-mdns-dns-and-wpad-and-relay-attacks.md](../../generic-methodologies-and-resources/pentesting-network/spoofing-llmnr-nbt-ns-mdns-dns-and-wpad-and-relay-attacks.md)
...
> Related: [../ntlm/places-to-steal-ntlm-creds.md](../ntlm/places-to-steal-ntlm-creds.md)
...
> Related: [kerberoast.md](kerberoast.md)
...
> Related: [kerberos-double-hop-problem.md](kerberos-double-hop-problem.md)
...
> Related: [printnightmare.md](printnightmare.md)
...
> Related: [over-pass-the-hash-pass-the-key.md](over-pass-the-hash-pass-the-key.md)

### Pass the Ticket

In the **Pass The Ticket (PTT)** attack method, attackers **steal a user's authentication ticket** instead of their password or hash values. This stolen ticket is then used to **impersonate the user**, gaining unauthorized access to resources and services within a network.

> Related: [pass-the-ticket.md](pass-the-ticket.md)
...
> Related: [abusing-ad-mssql.md](abusing-ad-mssql.md)

### IT asset/deployment platforms abuse

Third-party inventory and deployment suites often expose powerful paths to credentials and code execution. See:

> Related: [sccm-management-point-relay-sql-policy-secrets.md](sccm-management-point-relay-sql-policy-secrets.md)

> Related: [lansweeper-security.md](lansweeper-security.md)
...
> Related: [unconstrained-delegation.md](unconstrained-delegation.md)
...
> Related: [constrained-delegation.md](constrained-delegation.md)
...
> Related: [resource-based-constrained-delegation.md](resource-based-constrained-delegation.md)

### Permissions/ACLs Abuse

The compromised user could have some **interesting privileges over some domain objects** that could let you **move** laterally/**escalate** privileges.

> Related: [acl-persistence-abuse/](acl-persistence-abuse/)
...
> Related: [printers-spooler-service-abuse.md](printers-spooler-service-abuse.md)
...
> Related: [rdp-sessions-abuse.md](rdp-sessions-abuse.md)
...
> Related: [silver-ticket.md](silver-ticket.md)
...
> Related: [ad-certificates/account-persistence.md](ad-certificates/account-persistence.md)

### **Certificates Domain Persistence**

**Using certificates is also possible to persist with high privileges inside the domain:**

> Related: [ad-certificates/domain-persistence.md](ad-certificates/domain-persistence.md)
...
> Related: [dsrm-credentials.md](dsrm-credentials.md)
...
> Related: [security-descriptors.md](security-descriptors.md)
...
> Related: [ad-dynamic-objects-anti-forensics.md](ad-dynamic-objects-anti-forensics.md)

### Skeleton Key

Alter **LSASS** in memory to establish a **universal password**, granting access to all domain accounts.

> Related: [skeleton-key.md](skeleton-key.md)
...
> Related: [custom-ssp.md](custom-ssp.md)
...
> Related: [dcshadow.md](dcshadow.md)
...
> Related: [sid-history-injection.md](sid-history-injection.md)
...
> Related: [golden-dmsa-gmsa.md](golden-dmsa-gmsa.md)

Complementary delegated MSA attack (BadSuccessor – abusing migration attributes):

> Related: [badsuccessor-dmsa-migration-abuse.md](badsuccessor-dmsa-migration-abuse.md)
...
> Related: [external-forest-domain-oneway-inbound.md](external-forest-domain-oneway-inbound.md)
...
> Related: [external-forest-domain-one-way-outbound.md](external-forest-domain-one-way-outbound.md)
...
> Related: [https://cloud.hacktricks.wiki/en/pentesting-cloud/azure-security/az-lateral-movement-cloud-on-prem/azure-ad-connect-hybrid-identity/index.html](https://cloud.hacktricks.wiki/en/pentesting-cloud/azure-security/az-lateral-movement-cloud-on-prem/azure-ad-connect-hybrid-identity/index.html)
...
> Related: [ldap-signing-and-channel-binding.md](ldap-signing-and-channel-binding.md)
