...
> Related: [../authentication-credentials-uac-and-efs/](../authentication-credentials-uac-and-efs/)
...
> Related: [uiaccess-admin-protection-bypass.md](uiaccess-admin-protection-bypass.md)

Secure Desktop accessibility registry propagation can be abused for an arbitrary SYSTEM registry write (RegPwn):

> Related: [secure-desktop-accessibility-registry-propagation-regpwn.md](secure-desktop-accessibility-registry-propagation-regpwn.md)
...
> Related: [local-ntlm-reflection-via-smb-arbitrary-port.md](local-ntlm-reflection-via-smb-arbitrary-port.md)
...
> Attached file (not included in this KB): `CTX_WSUSpect_White_Paper (1).pdf`
...
> Related: [abusing-auto-updaters-and-ipc.md](abusing-auto-updaters-and-ipc.md)
...
> Related: [msi-wrapper.md](msi-wrapper.md)

### Create MSI with WIX

> Related: [create-msi-with-wix.md](create-msi-with-wix.md)
...
> Related: [../active-directory-methodology/laps.md](../active-directory-methodology/laps.md)
...
> Related: [../active-directory-methodology/privileged-groups-and-token-privileges.md](../active-directory-methodology/privileged-groups-and-token-privileges.md)
...
> Related: [privilege-escalation-abusing-tokens.md](privilege-escalation-abusing-tokens.md)
...
-
> Related: [service-triggers.md](service-triggers.md)
...
> Related: [appenddata-addsubdirectory-permission-over-service-registry.md](appenddata-addsubdirectory-permission-over-service-registry.md)
...
> Related: [notepad-plus-plus-plugin-autoload-persistence.md](notepad-plus-plus-plugin-autoload-persistence.md)
...
> Related: [privilege-escalation-with-autorun-binaries.md](privilege-escalation-with-autorun-binaries.md)
...
> Related: [arbitrary-kernel-rw-token-theft.md](arbitrary-kernel-rw-token-theft.md)
...
> Related: [kernel-race-condition-object-manager-slowdown.md](kernel-race-condition-object-manager-slowdown.md)
...
> Related: [windows-registry-hive-exploitation.md](windows-registry-hive-exploitation.md)
...
> Related: [dll-hijacking/writable-sys-path-dll-hijacking-privesc.md](dll-hijacking/writable-sys-path-dll-hijacking-privesc.md)
...
> Related: [dpapi-extracting-passwords.md](dpapi-extracting-passwords.md)
...
> Related: [com-hijacking.md](com-hijacking.md)
...
> Related: [telephony-tapsrv-arbitrary-dword-write-to-rce.md](telephony-tapsrv-arbitrary-dword-write-to-rce.md)
...
> Related: [../protocol-handler-shell-execute-abuse.md](../protocol-handler-shell-execute-abuse.md)
...
> Related: [../authentication-credentials-uac-and-efs/uac-user-account-control.md](../authentication-credentials-uac-and-efs/uac-user-account-control.md)
