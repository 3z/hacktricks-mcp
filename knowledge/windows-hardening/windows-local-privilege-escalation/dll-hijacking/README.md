...
> Related: [advanced-html-staged-dll-sideloading.md](advanced-html-staged-dll-sideloading.md)
...
> Related: [writable-sys-path-dll-hijacking-privesc.md](writable-sys-path-dll-hijacking-privesc.md)
