...
> Related: [homograph-attacks.md](homograph-attacks.md)
...
> Related: [clone-a-website.md](clone-a-website.md)
...
> Related: [phishing-documents.md](phishing-documents.md)
...
> Related: [detecting-phising.md](detecting-phising.md)
...
> Related: [ai-agent-mode-phishing-abusing-hosted-agent-browsers.md](ai-agent-mode-phishing-abusing-hosted-agent-browsers.md)

See also – AI agent abuse of local CLI tools and MCP (for secrets inventory and detection):

> Related: [ai-agent-abuse-local-ai-cli-tools-and-mcp.md](ai-agent-abuse-local-ai-cli-tools-and-mcp.md)
...
> Related: [clipboard-hijacking.md](clipboard-hijacking.md)

## Mobile Phishing & Malicious App Distribution (Android & iOS)

> Related: [mobile-phishing-malicious-apps.md](mobile-phishing-malicious-apps.md)
