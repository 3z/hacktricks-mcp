...
> Related: [../bypass-bash-restrictions/](../bypass-bash-restrictions/)

## Python Jails

Tricks about escaping from python jails in the following page:

> Related: [../../generic-methodologies-and-resources/python/bypass-python-sandboxes/](../../generic-methodologies-and-resources/python/bypass-python-sandboxes/)
