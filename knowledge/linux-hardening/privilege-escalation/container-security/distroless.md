...
> Related: [../../bypass-bash-restrictions/bypass-fs-protections-read-only-no-exec-distroless/](../../bypass-bash-restrictions/bypass-fs-protections-read-only-no-exec-distroless/)
