...
> Related: [../../binary-exploitation/linux-kernel-exploitation/adreno-a7xx-sds-rb-priv-bypass-gpu-smmu-kernel-rw.md](../../binary-exploitation/linux-kernel-exploitation/adreno-a7xx-sds-rb-priv-bypass-gpu-smmu-kernel-rw.md)
> Related: [../../binary-exploitation/linux-kernel-exploitation/arm64-static-linear-map-kaslr-bypass.md](../../binary-exploitation/linux-kernel-exploitation/arm64-static-linear-map-kaslr-bypass.md)
...
> Related: [container-security/](container-security/)
...
> Related: [wildcards-spare-tricks.md](wildcards-spare-tricks.md)
...
> Related: [socket-command-injection.md](socket-command-injection.md)
...
> Related: [containerd-ctr-privilege-escalation.md](containerd-ctr-privilege-escalation.md)

## **RunC** privilege escalation

If you find that you can use the **`runc`** command read the following page as **you may be able to abuse it to escalate privileges**:

> Related: [runc-privilege-escalation.md](runc-privilege-escalation.md)
...
> Related: [d-bus-enumeration-and-command-injection-privilege-escalation.md](d-bus-enumeration-and-command-injection-privilege-escalation.md)
...
> Related: [interesting-groups-linux-pe/](interesting-groups-linux-pe/)
...
> Related: [https://gtfobins.github.io/](https://gtfobins.github.io/)

> Related: [https://gtfoargs.github.io/](https://gtfoargs.github.io/)
...
> Related: [ld.so.conf-example.md](ld.so.conf-example.md)
...
> Related: [linux-capabilities.md](linux-capabilities.md)
...
> Related: [ssh-forward-agent-exploitation.md](ssh-forward-agent-exploitation.md)
...
> Related: [nfs-no_root_squash-misconfiguration-pe.md](nfs-no_root_squash-misconfiguration-pe.md)

### Escaping from restricted Shells

> Related: [escaping-from-limited-bash.md](escaping-from-limited-bash.md)

### Cisco - vmanage

> Related: [cisco-vmanage.md](cisco-vmanage.md)
...
> Related: [android-rooting-frameworks-manager-auth-bypass-syscall-hook.md](android-rooting-frameworks-manager-auth-bypass-syscall-hook.md)
...
> Related: [vmware-tools-service-discovery-untrusted-search-path-cve-2025-41244.md](vmware-tools-service-discovery-untrusted-search-path-cve-2025-41244.md)
