...
> Related: [macos-library-injection/](macos-library-injection/)
...
> Related: [macos-function-hooking.md](macos-function-hooking.md)
...
> Related: [macos-ipc-inter-process-communication/](macos-ipc-inter-process-communication/)

### Electron Applications Injection

Electron applications executed with specific env variables could be vulnerable to process injection:

> Related: [macos-electron-applications-injection.md](macos-electron-applications-injection.md)
...
> Related: [macos-chromium-injection.md](macos-chromium-injection.md)
...
> Related: [macos-dirty-nib.md](macos-dirty-nib.md)
...
> Related: [macos-java-apps-injection.md](macos-java-apps-injection.md)
...
> Related: [macos-.net-applications-injection.md](macos-.net-applications-injection.md)

### Perl Injection

Check different options to make a Perl script execute arbitrary code in:

> Related: [macos-perl-applications-injection.md](macos-perl-applications-injection.md)

### Ruby Injection

I't also possible to abuse ruby env variables to make arbitrary scripts execute arbitrary code:

> Related: [macos-ruby-applications-injection.md](macos-ruby-applications-injection.md)
