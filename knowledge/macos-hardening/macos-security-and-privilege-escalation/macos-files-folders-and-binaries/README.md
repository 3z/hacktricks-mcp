...
> Related: [macos-sensitive-locations.md](macos-sensitive-locations.md)

### Vulnerable pkg installers

> Related: [macos-installers-abuse.md](macos-installers-abuse.md)
...
> Related: [macos-bundles.md](macos-bundles.md)
...
> Related: [universal-binaries-and-mach-o-format.md](universal-binaries-and-mach-o-format.md)

## macOS memory dumping

> Related: [macos-memory-dumping.md](macos-memory-dumping.md)
